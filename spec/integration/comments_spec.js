...
// #3
  ...
  // CRUD tests for guest users begin
  ...
  // #5
     ...
     });    // CRUD tests for guest users end


// CRUD tests for signed in user begin
...
// #3
   ...
   // test to confirm a signed-in member can't destroy another member's comment
        describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
            beforeEach(done => {
                User.create({
                ...
                Comment.findAll().then(comments => {
                    ...
                    request.post(
                        `${base}${this.topic.id}/posts/${
                            this.post.id
                        }/comments/${this.comment.id}/destroy`,
                        (err, res, body) => {
   ...
   //an admin can delete a member user's comment
    describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
        beforeEach(done => {
            User.create({
